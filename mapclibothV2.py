...
def get_interactive_input():
    """Get input parameters interactively from command line."""
    print("\nMap Generator Tool")
    print("=================")
    print("\nEnter parameters separated by dashes (-)")
    print("Format: - x - y - size - mapname - source - outputdir [-nad83 zone]")
    print("Example: - -79.389318 - 43.641703 - 2 - toronto - arc - ./output")
    print("Or enter -f followed by parameter file path and output directory")
    print("Example: -f params.txt - ./output\n")

    try:
        # Get input line
        input_line = input("Enter parameters: ").strip()
